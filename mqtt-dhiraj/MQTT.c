...
int mqtt_Connect()
{
    ...
    MQTTClient_create(&client, "ssl://b5feec6d24bf4ded89cbd15945207fb9.s2.eu.hivemq.cloud:8883", 
    "Subscriber",MQTTCLIENT_PERSISTENCE_NONE, NULL);
...
int mqtt_Subscribe(const char * sub_topic)
{
    ...
    int qos      = 1;
    retVal = MQTTClient_subscribe(client, sub_topic, qos);
